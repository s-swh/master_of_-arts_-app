...
// 设置PopupWindow是否能响应点击事件
    ...
    public void OnOrderdetails(CourseOrderBean orderBean) {
        ...
        CourseOrderBean.DataBean.OrderMsgBean orderMsg1 = data.getOrderMsg();
        CourseOrderBean.DataBean.OrderMsgBean.CourseDetailBean course_detail1 = orderMsg1.getCourse_detail();
        String teacher_name = course_detail1.getTeacher_name();
