...
public interface LoginContreater {
    ...
    interface IPreanter{
        ...
        // 短信验证码登录
        void OnLoginSuccess(String phone,String code,String registration_id);
        // 账号密码登录
        void OnAccout(String account,String pwd,String registration_id);
        //重置密码
    ...
    interface IModel{
        ...
        // 短信验证码登录
        void OnLoginSuccess(String phone,String code,String registration_id,OnLoginCoallack onLoginCoallack);
        interface OnLoginCoallack{
            void OnCodeLogin(SMSLogin smsLogin);
        }
        //  账号密码登录
        void OnAccout(String account,String pwd,String registration_id,OnAccoutCoallack onAccoutCoallack);
