...
public class MoreCommentsAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        ((MoreCommentsViewHorder) holder).ratingbar.setRating(score);
    }
    ...
    class MoreCommentsViewHorder extends RecyclerView.ViewHolder {
        ...
        public MoreCommentsViewHorder(@NonNull View itemView) {
            super(itemView);
            more_iv = itemView.findViewById(R.id.item_img);
            ratingbar = itemView.findViewById(R.id.ratingbar);
            more_name = itemView.findViewById(R.id.item_title);
           more_time= itemView.findViewById(R.id.item_date);
