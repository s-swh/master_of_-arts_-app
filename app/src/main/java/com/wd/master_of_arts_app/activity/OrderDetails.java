...
public class OrderDetails extends BaseActivity implements OrderContreater.IView {
    ...
    protected void initView() {
        ...
        qpj1 = findViewById(R.id.qpj1);
        deta_pay_method = findViewById(R.id.deta_pay_method);
    }

    @Override
    protected void initData() {
        qpj1.setOnClickListener(new View.OnClickListener() {
...
// 设置PopupWindow是否能响应点击事件
    ...
    public void OnOrderdetails(CourseOrderBean orderBean) {
        ...
        String teacher_name = data1.getOrderMsg().getCourse_detail().getTeacher_name();
        tv_teacher_name.setText("任课老师："+teacher_name);
        ...
        tv_create.setText("下单时间："+create_time1);
        pay_price = orderMsg.getPay_price();
        ...
        if(pay_method.equals("alipay")){
            deta_pay_method.setText("支付方式：支付宝支付");
        }else if(pay_method.equals("wxpay")){
            deta_pay_method.setText("支付方式：微信支付");
        }else if(pay_method.equals("offline")){
            deta_pay_method.setText("支付方式：线下支付");
        }
